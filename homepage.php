                           ...
                           foreach($comments as $commentParse){
                               ...
                               <div class = "comment-header">
                                   <div class = "author-comment">
                                       ...
                                       <div class = "author-name-comment">'.$usercomment["username"].'</div>
                                   </div>
                            ...
                            $modal.= '<div class="modal fade " id="postModal-'.$post['PostID'].'" data-bs-backdrop="static" data-bs-keyboard="false" tabindex="-1" aria-labelledby="staticBackdropLabel" aria-hidden="true">
  ...
  <div class="modal-dialog modal-dialog-centered">
    <div class="modal-content">
      ...
      <?php
        ...
        if(isset($_POST['btnCommentDelete'])){	
